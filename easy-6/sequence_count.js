...
// Output: array
// Rule:
// - first argument is count: length of the returned array
// - second argument: starting point of sequence
// - count 0 returns empty array
// - each element of the array should be muliple of starting number
//  - current value * starting number

function sequence(count, startNum) {
  let result = [];
  for (let index = 1; index <= count; index += 1) {
    result.push(index * startNum);
  }
