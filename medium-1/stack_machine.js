...
// the stack, and stores the result back in the register. For example, if we
// start with a stack of [3, 6, 4] (where 4 is the topmost item in the stack)
// and a register value of 7, the MULT operation transforms the stack to [3, 6]
// (the 4 is removed), and the result of the multiplication, 28, is left in the
// register. If we do another MULT at this point, the stack is transformed to
...
DIV : Pop a value from the stack and divide it into the register value, storing
  the integer result in the register.
MOD : Pop a value from the stack and divide it into the register value, storing
